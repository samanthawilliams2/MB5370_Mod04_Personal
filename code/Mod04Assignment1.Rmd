...
```{r}
ggplot(data_combined, aes(x = Transects, y = NewSpecies, color = Method)) +
  geom_point() +
  geom_smooth() +
  labs(x = "Number of Transects", y = "N New Species") +
  theme_minimal() +  # Ensures the full box around the plot
  theme(
